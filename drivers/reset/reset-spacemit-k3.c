...
#define APMU_ALZO_CLK_RES_CTRL          0xd4
...
#define APMU_PCIE_CLK_RES_CTRL_PORTB    0x1C8
#define APMU_PCIE_CLK_RES_CTRL_PORTC    0x1D0
...
static const struct spacemit_reset_signal
	...
	[RESET_USB2]	    = { APMU_USB_CLK_RES_CTRL, BIT(1)|BIT(2)|BIT(3), BIT(1)|BIT(2)|BIT(3), 0, RST_BASE_TYPE_APMU },
	...
	[RESET_ALZO]        = { APMU_ALZO_CLK_RES_CTRL, BIT(1), BIT(1), 0, RST_BASE_TYPE_APMU },
	...
	[RESET_UFS_EMU_SYMBCLK]  = { APMU_UFS_CLK_RES_CTRL, BIT(9), BIT(9), 0, RST_BASE_TYPE_APMU },
