...
void init_snps_lp45(unsigned DDRC_BASE, unsigned rst_code)
{
	...
	REG32(DDRC_BASE + 0x00010308) = 0x00000001;
	REG32(DDRC_BASE + 0x00010380) = 0x0801a010;
	REG32(DDRC_BASE + 0x00010384) = 0x80002000;
	REG32(DDRC_BASE + 0x00010390) = 0x083c0810;
	REG32(DDRC_BASE + 0x00010500) = 0x00110111;
	REG32(DDRC_BASE + 0x00010508) = 0xc0000000; // TODO ctrlupd
	REG32(DDRC_BASE + 0x00010510) = 0x00010005;
	REG32(DDRC_BASE + 0x00010518) = 0x80000000;
	REG32(DDRC_BASE + 0x00010b80) = 0x00000001;
	...
	REG32(DDRC_BASE + 0x00021004) = 0x00002000;
	REG32(DDRC_BASE + 0x00021008) = 0x00006000;
	REG32(DDRC_BASE + 0x00021094) = 0x00120007;
	...
	REG32(DDRC_BASE + 0x00022094) = 0x00210002;
	...
	REG32(DDRC_BASE + 0x00023094) = 0x00000005;
	...
	REG32(DDRC_BASE + 0x00000000) = 0x1c0b2417;
	REG32(DDRC_BASE + 0x00000004) = 0x000b0620;
	REG32(DDRC_BASE + 0x00000008) = 0x060c0f11;
	REG32(DDRC_BASE + 0x0000000c) = 0x000a1721;
	...
	REG32(DDRC_BASE + 0x00000024) = 0x0002030c;
	REG32(DDRC_BASE + 0x00000030) = 0x00030000;
	REG32(DDRC_BASE + 0x00000034) = 0x09100002;
	REG32(DDRC_BASE + 0x00000038) = 0x001600cf;
	REG32(DDRC_BASE + 0x0000005c) = 0x00690007;
	REG32(DDRC_BASE + 0x00000060) = 0x000d110b;
	REG32(DDRC_BASE + 0x00000064) = 0x00001c04;
	REG32(DDRC_BASE + 0x00000078) = 0x00131113;
	REG32(DDRC_BASE + 0x00000080) = 0x00030406;
	REG32(DDRC_BASE + 0x00000500) = 0x00000510;
	REG32(DDRC_BASE + 0x00000504) = 0x00000000;
	REG32(DDRC_BASE + 0x00000508) = 0x00000000;
	REG32(DDRC_BASE + 0x0000050c) = 0x00000000;
	REG32(DDRC_BASE + 0x00000580) = 0x032b0213;
	REG32(DDRC_BASE + 0x00000584) = 0x00080303;
	REG32(DDRC_BASE + 0x00000588) = 0x00182b13;
	REG32(DDRC_BASE + 0x00000590) = 0x0c04000a;
	REG32(DDRC_BASE + 0x00000594) = 0x040c000f;
	REG32(DDRC_BASE + 0x000005a0) = 0x00020202;
	REG32(DDRC_BASE + 0x000005a4) = 0x00000201;
	REG32(DDRC_BASE + 0x000005a8) = 0x010b000c;
	REG32(DDRC_BASE + 0x000005ac) = 0x000a00ae;
	REG32(DDRC_BASE + 0x000005b0) = 0x0000002d;
	REG32(DDRC_BASE + 0x000005b4) = 0x7800000a;
	REG32(DDRC_BASE + 0x000005b8) = 0x000000e8;
	REG32(DDRC_BASE + 0x00000600) = 0xc0220823;
	REG32(DDRC_BASE + 0x00000604) = 0x00cb0066;
	REG32(DDRC_BASE + 0x00000608) = 0x04320000; // change
	REG32(DDRC_BASE + 0x0000060c) = 0x0a000000;
	REG32(DDRC_BASE + 0x00000650) = 0x0000008b;
	REG32(DDRC_BASE + 0x00000800) = 0x00100346;
	REG32(DDRC_BASE + 0x00000804) = 0x01b00065;
	...
	REG32(DDRC_BASE + 0x00000d08) = 0x00000f02;
	REG32(DDRC_BASE + 0x00000d0c) = 0x03d5006c;
